...
set tracefile [open 20_random_tcp.tr w]
$ns trace-all $tracefile

#Open the NAM trace file
set namfile [open 20_random_tcp.nam w]
...
set finalyy_ [expr $yy_]
set rng_time [expr rand()*$val(stop)]
$ns at $rng_time "$n9 setdest $finalxx_ $finalyy_ 25.0"
...
set finalyy_ [expr $yy_]
set rng_time [expr rand()*$val(stop)]
$ns at $rng_time "$n15 setdest $finalxx_ $finalyy_ 25.0"
