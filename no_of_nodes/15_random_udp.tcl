...
set tracefile [open 15_random_udp.tr w]
$ns trace-all $tracefile

#Open the NAM trace file
set namfile [open 15_random_udp.nam w]
...
set finalyy_ [expr $yy_]
set rng_time [expr rand()*$val(stop)]
$ns at $rng_time "$n8 setdest $finalxx_ $finalyy_ 25.0"
...
set finalyy_ [expr $yy_]
set rng_time [expr rand()*$val(stop)]
$ns at $rng_time "$n13 setdest $finalxx_ $finalyy_ 25.0"
#===================================
#        Agents Definition
#===================================
