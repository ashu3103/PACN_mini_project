...
factors = ['movement_of_nodes', 'no_of_nodes', 'packet_loss']
...
# array1 = np.array([data[factors[2]]['15_random_udp.txt']['packet_loss'], data[factors[1]]['15_random_tcp.txt']['packet_loss']])
# array_1 = array1.transpose()

# array2 = np.array([data[factors[2]]['15_random_udp.txt']['delay'], data[factors[1]]['15_random_tcp.txt']['delay']])
# array_2 = array2.transpose()

# array3 = np.array([data[factors[2]]['15_random_udp.txt']['throughput'], data[factors[1]]['15_random_tcp.txt']['throughput']])
# array_3 = array3.transpose()
